...
export class AdministradorAsesorController {
  ...
  async find(
    ...
    return this.administradorRepository.asesor(id).find(filter);
  }
  ...
  async create(
    ...
    return this.administradorRepository.asesor(id).create(asesor);
  }
  ...
  async patch(
    ...
    return this.administradorRepository.asesor(id).patch(asesor, where);
  }
  ...
  async delete(
    ...
    return this.administradorRepository.asesor(id).delete(where);
  }
}
