...
> {
  ...
  public readonly asesor: HasManyRepositoryFactory<Asesor, typeof Administrador.prototype.id>;
  ...
  constructor(
    ...
    this.asesor = this.createHasManyRepositoryFactoryFor('asesor', asesorRepositoryGetter,);
